...
// Task 10 – Routing Implementation in React
...
function NotFound() {
  return (
    <section className="page-card not-found-card">
      ...
      <p>The page you are looking for does not exist. Please use the navigation above to continue.</p>
    </section>
  );
}
      ...
      <div className="site-shell">
        <header className="site-header">
          <div className="header-inner">
            <div className="brand">My Dev</div>
